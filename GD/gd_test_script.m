...
if strcmp(DATASET,'USPS')
  load(sprintf('trained_network/USPS_gd_network_%f_%d.mat',ALPHA,NET_DEPTH));
...
elseif strcmp(DATASET,'MNIST')
  load(sprintf('trained_network/MNIST_gd_network_%f_%d.mat',ALPHA,NET_DEPTH));
...
sp_code=gd_fprop_mass(test_data,Wd',S,repmat(ALPHA,size(Wd,2),1),network.T);
